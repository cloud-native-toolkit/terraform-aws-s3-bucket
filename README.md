...
Module to Upload files to AWS S3 bucket, as per instructions mentioned in https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_object
...
module "aws-s3-bucket" {
  source = "github.com/ibm-garage-cloud/terraform-aws-s3-bucket.git"
